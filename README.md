...
- 🔭 I’m currently working on the UI of ([P-Ick App by a Hamburg Startup](https://hmbrg-p-ick-app-creative-ui.pages.dev/) ) as well as on the restructuring of my social media webapp "MaHalle: Das Kiez-Gesichterbuch" ([the previous (Next.js) version](https://mahalle-kiez-gesichterbuch.vercel.app/) )
